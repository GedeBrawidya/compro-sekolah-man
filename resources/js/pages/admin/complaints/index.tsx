...
export default function ComplaintsIndex({ complaint_link }: Props) {
    ...
    const defaultLegalisirLink = 'https://docs.google.com/forms/d/e/1FAIpQLSeQFirrXnNpCuZEPGK4SOIWuBrs4c3sEPJLEoZB9l0LRWbTqw/formResponse';
    const [formLink, setFormLink] = useState(complaint_link || defaultLegalisirLink);
    const [isSavingLink, setIsSavingLink] = useState(false);

    const handleSaveLink = (e: FormEvent) => {
        e.preventDefault();
        setIsSavingLink(true);
        router.post('/admin/complaints/link', { complaint_link: formLink }, {
                ...
                <div className="bg-white border border-[#c8dac5] rounded-3xl p-5 sm:p-6 shadow-xs space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#e2ebd9] pb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="text-base font-extrabold text-[#142921]">Tautan Google Form Layanan Pengaduan</h3>
                                <p className="text-xs text-[#527365]">
                                    Kapan pun ada perubahan link Google Form pengaduan, Anda dapat memperbaruinya di sini tanpa perlu mengubah kode web.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="p-4 rounded-2xl bg-[#f4f8f3] border border-[#c8dac5]/80 flex items-start gap-3 text-xs text-[#265243]">
                        ...
                        <div className="space-y-1">
                            <p className="font-extrabold">Informasi Statistik & Laporan Pengaduan Google Form:</p>
                            <p className="text-[#366152] leading-relaxed">
                                Karena pengisian pengaduan dialihkan langsung ke Google Form, statistik laporan masuk (seperti grafik tanggapan, rekap keluhan, dan lampiran) dapat Anda pantau secara langsung dan akurat di halaman <strong>Jawaban / Response Google Form</strong> atau <strong>Google Sheets</strong> sekolah.
                            </p>
                        </div>
                    </div>
                </div>
