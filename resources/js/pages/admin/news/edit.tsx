                    ...
                    if (errs.title || errs.content) {
                        setValidationErrorModal({
                            ...
                            message:
                                errs.title ||
                                errs.content ||
                                'Terjadi kesalahan saat menyimpan perubahan berita.',
                        });
                    }
                    setProcessing(false);
                },
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            ...
                            <button
                                ...
                                className="w-full rounded-xl border-2 py-2.5 text-xs font-extrabold shadow-xs transition-all hover:bg-[#eaf2e7]"
                            >
                                {thumbnailPreview
                                    ? 'Ganti Gambar'
                                    : 'Pilih Gambar'}
                            ...
                            <div className="space-y-3">
                                {(['published', 'draft'] as const).map((s) => (
                                    ...
                                    >
                                        ...
                                        <div>
                                            <p
                                                className={`text-xs font-extrabold ${status === s ? 'text-white' : 'text-[#142921]'}`}
                                            >
                                                {s === 'published'
                                                    ? 'Publish Langsung'
                                            ...
                                            <p
                                                className={`mt-0.5 text-[11px] font-semibold ${status === s ? 'text-emerald-100' : 'text-[#527365]'}`}
                                            >
                                                {s === 'published'
                                                    ? 'Langsung tampil di halaman publik'
                                                    : 'Belum tampil, disimpan sebagai draf'}
                                            </p>
                                        </div>
                                    </label>
                                ))}
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="mt-1.5 text-xs leading-relaxed font-semibold text-[#2e5445]">
                                    ...
                                    {status === 'published'
                                        ? 'mempublikasikan perubahan berita ini secara langsung?'
                                        : 'menyimpan perubahan berita ini sebagai draf internal?'}
                                </p>
                            </div>
