        ...
        <div className="space-y-1.5">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    required={required}
                    className={`w-full rounded-xl border border-slate-200 bg-slate-50/70 py-2.5 text-xs font-semibold text-slate-800 shadow-2xs transition-all duration-200 placeholder:text-slate-400 hover:bg-slate-50 hover:border-[#265243]/50 focus:border-[#265243] focus:bg-white focus:ring-4 focus:ring-[#265243]/10 focus:outline-none ${
    ...
    return (
        <div className="space-y-1.5">
            ...
            <textarea
                ...
                onChange={(e) => onChange(e.target.value)}
                placeholder={placeholder}
                className="w-full resize-y rounded-xl border border-slate-200 bg-slate-50/70 px-4 py-2.5 text-xs font-semibold text-slate-800 shadow-2xs transition-all duration-200 placeholder:text-slate-400 hover:bg-slate-50 hover:border-[#265243]/50 focus:border-[#265243] focus:bg-white focus:ring-4 focus:ring-[#265243]/10 focus:outline-none"
            />
            {hint && (
                <p className="text-[11px] font-medium text-slate-500">{hint}</p>
            )}
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60 p-4 backdrop-blur-sm">
            <div className="w-full max-w-lg overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl">
                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-6 py-4 text-white">
                ...
                <form onSubmit={handleSubmit} className="space-y-4 p-6">
                    ...
                    <div>
                        ...
                        {imagePreview ? (
                            ...
                            <div
                                ...
                                className="flex h-36 w-full cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-emerald-300 bg-emerald-50/30 transition-all duration-300 hover:border-[#265243] hover:bg-emerald-50 hover:ring-2 hover:ring-[#265243]/20"
                            >
                    ...
                    <div className="flex items-center justify-end gap-3 border-t border-slate-100 pt-3">
                        ...
                        <button
                            ...
                            className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-2 text-xs font-bold text-white shadow-sm transition-all hover:shadow-md hover:from-[#1d3f34] hover:to-[#17332a] disabled:opacity-50"
                        >
        ...
        <>
            ...
            <div className="w-full space-y-6 p-4 sm:p-6">
                    ...
                    {TABS.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`flex flex-1 min-w-[120px] cursor-pointer items-center justify-center gap-2 rounded-xl px-3.5 py-2.5 text-xs font-bold transition-all duration-300 ${
                                    active
                                        ? 'scale-[1.02] bg-gradient-to-r from-[#265243] to-[#1d4236] text-white shadow-md shadow-[#265243]/20'
                                        : 'text-slate-600 hover:bg-emerald-50/70 hover:text-[#265243] hover:shadow-xs'
                                }`}
                            >
                                <Icon
                                    className={`h-4 w-4 shrink-0 transition-colors ${active ? 'text-white' : 'text-[#265243]'}`}
                                />
                    ...
                    <div className="space-y-4">
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            ...
                            <button
                                ...
                                className="inline-flex cursor-pointer items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#265243] to-[#1f4337] px-4 py-2.5 text-xs font-bold text-white shadow-xs transition-all duration-300 hover:shadow-md hover:from-[#1d3f34] hover:to-[#17332a] hover:-translate-y-0.5"
                            >
                        ...
                        {banners.length === 0 ? (
                            <div className="rounded-2xl border-2 border-dashed border-slate-200 bg-white p-12 text-center shadow-xs transition-all duration-300 hover:border-[#265243] hover:bg-emerald-50/20">
                            ...
                            <div className="space-y-3">
                                {banners.map((b) => (
                                    <div
                                        key={b.id}
                                        className={`flex flex-col sm:flex-row items-stretch overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xs transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md hover:bg-emerald-50/20 hover:-translate-y-0.5 ${
                                        ...
                                        <div className="flex flex-1 flex-col justify-between gap-3 p-5 sm:flex-row sm:items-center">
                                            ...
                                            <div className="flex shrink-0 items-center gap-2">
                                                <button
                                                    ...
                                                    className="cursor-pointer rounded-xl border border-slate-200 bg-slate-50 p-2 text-[#265243] transition-all hover:bg-emerald-100 hover:text-[#1a3a30]"
                                                    title="Edit"
                                                >
                ...
                {activeTab === 'sekolah' && (
                    <form onSubmit={saveSettings} className="space-y-6">
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            {/* Logo Card */}
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md">
                                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-3.5 text-white">
                                    <h3 className="flex items-center gap-2 text-xs font-bold tracking-wider uppercase">
                                        <Sparkles className="h-4 w-4 text-emerald-300" />
                                        Logo Sekolah
                                    </h3>
                                    <span className="rounded-full border border-white/30 bg-white/20 px-2.5 py-0.5 text-[10px] font-bold text-white backdrop-blur-xs">
                                        Identitas
                                    </span>
                                </div>
                                ...
                                <div className="p-6 flex flex-col items-center space-y-4">
                                    {logoPreview ? (
                                        <div className="flex w-full flex-col items-center gap-4">
                                            <div className="group relative flex h-40 w-40 items-center justify-center rounded-2xl border border-slate-200 bg-slate-50/50 p-4 shadow-inner transition-all duration-300 hover:border-[#265243] hover:bg-emerald-50/30">
                                                <img
                                                    src={logoPreview}
                                                    alt="Logo Sekolah"
                                                    onError={() =>
                                        ...
                                        <div
                                            ...
                                            className="flex h-44 w-full cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-emerald-300 bg-emerald-50/40 p-4 transition-all duration-300 hover:border-[#265243] hover:bg-emerald-50 hover:ring-2 hover:ring-[#265243]/20"
                                        >
                            ...
                            {/* Identitas Card */}
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md lg:col-span-2">
                                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-3.5 text-white">
                                    <h3 className="flex items-center gap-2 text-xs font-bold tracking-wider uppercase">
                        ...
                        <div className="flex justify-end">
                            <button
                                type="submit"
                                disabled={saving}
                                className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-gradient-to-r from-[#265243] to-[#1f4337] px-7 py-3 text-xs font-bold text-white shadow-md shadow-[#265243]/20 transition-all duration-300 hover:shadow-lg hover:from-[#1d3f34] hover:to-[#17332a] hover:-translate-y-0.5 disabled:opacity-50"
                            >
                                <Save className="h-4 w-4" />{' '}
                                {saving
                                    ? 'Menyimpan...'
                ...
                {activeTab === 'media' && (
                    <form onSubmit={saveSettings} className="space-y-6">
                        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md">
                            <div className="bg-gradient-to-r from-[#265243] to-[#1f4337] px-6 py-4 text-white">
                                <h3 className="flex items-center gap-2 text-base font-bold">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        ...
                                        <div
                                            ...
                                            className={`flex cursor-pointer items-center justify-between rounded-xl border p-4 transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:bg-emerald-50/50 ${
                                                principalMediaType === 'video'
                                                    ? 'border-[#265243] bg-emerald-50/70 ring-2 ring-[#265243]/20'
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {principalMediaPhotoPreview ? (
                                                ...
                                                <div
                                                    ...
                                                    className="flex h-40 w-full max-w-xl cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-emerald-300 bg-emerald-50/40 transition-all duration-300 hover:border-[#265243] hover:bg-emerald-50 hover:ring-2 hover:ring-[#265243]/20"
                                                >
                                                    <UploadCloud className="h-8 w-8 text-[#265243]" />
                                                    <p className="text-center text-xs font-bold text-slate-700">
                    ...
                    <form onSubmit={saveSettings} className="space-y-6">
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            ...
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md">
                                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-3.5 text-white">
                                    <h3 className="flex items-center gap-2 text-xs font-bold tracking-wider uppercase">
                                        <GraduationCap className="h-4 w-4 text-emerald-300" /> Foto Kepala Sekolah
                                    </h3>
                                </div>
                                <div className="p-6 flex flex-col items-center space-y-4">
                                    {principalPhotoPreview ? (
                                        ...
                                        <div
                                            ...
                                            className="flex h-48 w-36 cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-emerald-300 bg-emerald-50/40 p-3 transition-all duration-300 hover:border-[#265243] hover:bg-emerald-50 hover:ring-2 hover:ring-[#265243]/20"
                                        >
                            ...
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md lg:col-span-2">
                                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-3.5 text-white">
                                    <h3 className="flex items-center gap-2 text-xs font-bold tracking-wider uppercase">
                                        <School className="h-4 w-4 text-emerald-300" /> Data & Kata Sambutan Kepala Sekolah
                                    </h3>
                                </div>
                    ...
                    <form onSubmit={saveSettings} className="space-y-6">
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md">
                                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-3.5 text-white">
                                    <h3 className="flex items-center gap-2 text-xs font-bold tracking-wider uppercase">
                                        <Target className="h-4 w-4 text-emerald-300" /> Visi Sekolah
                                    </h3>
                                </div>
                                <div className="p-6">
                                    <FieldTextarea
                            ...
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md">
                                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-3.5 text-white">
                                    <h3 className="flex items-center gap-2 text-xs font-bold tracking-wider uppercase">
                                        <Target className="h-4 w-4 text-emerald-300" /> Misi Sekolah
                                    </h3>
                                </div>
                                <div className="p-6">
                                    <FieldTextarea
                        ...
                        {milestones.length === 0 ? (
                            ...
                            <div className="space-y-3">
                                {milestones.map((ms) => (
                                    <div
                                        key={ms.id}
                                        className="flex items-stretch overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xs transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md hover:bg-emerald-50/20 hover:-translate-y-0.5"
                                    >
                                        {/* Year Badge */}
                    ...
                    <form onSubmit={saveSettings} className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {footerBannerBgPreview ? (
                                            ...
                                            <div
                                                ...
                                                className="flex h-32 w-full cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-emerald-300 bg-emerald-50/40 transition-all duration-300 hover:border-[#265243] hover:bg-emerald-50 hover:ring-2 hover:ring-[#265243]/20"
                                            >
                        ...
                        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md">
                                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-3.5 text-white">
                                    <h3 className="flex items-center gap-2 text-xs font-bold tracking-wider uppercase">
                                        <Phone className="h-4 w-4 text-emerald-300" /> Informasi Kontak Footer
                                    </h3>
                                </div>
                                <div className="p-6 space-y-4">
                                    <FieldInput
                            ...
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:border-[#265243] hover:ring-2 hover:ring-[#265243]/20 hover:shadow-md">
                                <div className="flex items-center justify-between bg-gradient-to-r from-[#265243] to-[#1f4337] px-5 py-3.5 text-white">
                                    <h3 className="flex items-center gap-2 text-xs font-bold tracking-wider uppercase">
                                        <Globe className="h-4 w-4 text-emerald-300" /> Media Sosial
                                    </h3>
                                </div>
                                <div className="p-6 space-y-4">
                                    <FieldInput
                        ...
                        <div className="flex justify-end">
                            <button
                                type="submit"
                                disabled={saving}
                                className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-gradient-to-r from-[#265243] to-[#1f4337] px-6 py-2.5 text-xs font-bold text-white shadow-md shadow-[#265243]/20 transition-all duration-300 hover:shadow-lg disabled:opacity-50"
                            >
                                <Save className="h-4 w-4" />{' '}
                                {saving
                                    ? 'Menyimpan...'
