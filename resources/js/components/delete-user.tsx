        ...
        <div className="max-w-xl space-y-4">
            <div>
                ...
                <p className="mt-0.5 text-xs font-semibold text-[#2e5445]">
                    Hapus akun pengguna Anda beserta seluruh data yang terkait
                    secara permanen.
                </p>
            </div>
                ...
                <Dialog>
                    <DialogTrigger asChild>
                        <button
                            ...
                            className="rounded-xl bg-rose-600 px-4 py-2 text-xs font-bold text-white shadow-xs transition-all hover:bg-rose-700"
                        >
                            Hapus Akun Saya
                        </button>
                    </DialogTrigger>
                    ...
                    >
                        ...
                        <DialogDescription className="text-xs text-[#2e5445]">
                            ...
                            data terkait akan dihapus secara permanen. Masukkan
                            kata sandi Anda untuk mengonfirmasi.
                        </DialogDescription>
                                ...
                                <>
                                    ...
                                    <DialogFooter className="gap-2 pt-2">
                                        ...
                                        <button
                                            ...
                                            className="rounded-xl bg-rose-600 px-4 py-2 text-xs font-bold text-white shadow-xs transition-all hover:bg-rose-700 disabled:opacity-50"
                                        >
                                            {processing
                                                ? 'Menghapus...'
